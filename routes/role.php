...
Route::get('role/{id}/permissions', [RolesController::class, 'getPermissions'])->name('role.permissions')->middleware('permission:admin.role.edit');
Route::post('role/{id}/permissions', [RolesController::class, 'postPermissions'])->name('role.permissions.submit')->middleware('permission:admin.role.edit');
