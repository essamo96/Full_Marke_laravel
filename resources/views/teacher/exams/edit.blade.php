...
@section('title', 'Edit Exam | FULL MARK ACADEMY')
@section('page_title_en', 'Edit Exam')
@section('page_title_ar', 'تعديل الامتحان')
...
<form action="{{ route('teacher.exams.update', $exam) }}" method="POST" id="examForm">
    ...
    <div class="d-flex justify-content-end align-items-center mb-4 gap-2">
        ...
        <button type="submit" class="btn btn-luxury" data-en="Save Changes" data-ar="حفظ التعديلات">حفظ التعديلات</button>
    </div>
