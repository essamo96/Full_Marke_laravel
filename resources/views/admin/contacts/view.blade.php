        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <table id="contacts" class="table table-row-bordered gy-5">
                        <thead>
                            <tr class="fw-semibold fs-6 text-muted">
                                <th>#</th>
                                <th>{{ \App\Helpers\translate('company_id') }}</th></n><th>{{ \App\Helpers\translate('full_name') }}</th></n><th>{{ \App\Helpers\translate('contact_type') }}</th></n><th>{{ \App\Helpers\translate('subject') }}</th></n><th>{{ \App\Helpers\translate('message') }}</th></n>
