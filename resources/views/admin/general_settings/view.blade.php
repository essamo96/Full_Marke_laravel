        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <table id="generalsettings" class="table table-row-bordered gy-5">
                        <thead>
                            <tr class="fw-semibold fs-6 text-muted">
                                <th>#</th>
                                <th>{{ \App\Helpers\translate('company_id') }}</th>
                                <th>{{ \App\Helpers\translate('site_phone') }}</th>
                                <th>{{ \App\Helpers\translate('site_email') }}</th>
                                <th>{{ \App\Helpers\translate('site_address') }}</th>
