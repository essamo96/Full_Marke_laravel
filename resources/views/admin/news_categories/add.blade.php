                                            ...
                                            <div class="tab-pane fade show active" id="basic" role="tabpanel">
                                                <div class="row mb-5">
                                                    <div class="col-md-6 fv-row">
                                                        @include('admin.components.file-picker', ['name' => 'image', 'value' => (isset($info) ? $info->image : null) ?? old('image'), 'label' => \App\Helpers\translate('image'), 'folder' => 'news_categories'])
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="lang-{{ $locale }}" role="tabpanel">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="name_{{ $locale }}" class="form-control form-control-solid mb-2"
                                                            ...
                                                            value="{{ old('name_' . $locale, $info->{'name_' . $locale} ?? '') }}" />
                                                    </div>
                                                    
                                                    @if($locale === 'en')
                                                    <div class="mb-10 fv-row">
                                                        <label class="required form-label">Slug</label>
                                                        <input type="text" name="slug" class="form-control form-control-solid mb-2"
                                                            placeholder="slug"
