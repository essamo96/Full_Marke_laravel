            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        ...
                        <table id="news" class="table table-row-bordered gy-5">
                            <thead>
                                <tr class="fw-semibold fs-6 text-muted">
                                    <th>#</th>
                                    <th>{{ \App\Helpers\translate('company_id') }}</th>
                                    <th>{{ \App\Helpers\translate('user_id') }}</th>
                                    <th>{{ \App\Helpers\translate('pub_date') }}</th>
                                    <th>{{ \App\Helpers\translate('title') }}</th>
                                    <th>{{ \App\Helpers\translate('publish') }}</th>
                                    <th>{{ \App\Helpers\translate('main') }}</th>
                                    <th>{{ \App\Helpers\translate('category_id') }}</th>
