...
<head>
    ...
    <!-- TinyMCE CSS -->
    <link rel="stylesheet" href="{{ asset('admin/tinymce/js/tinymce/skins/ui/oxide/skin.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/tinymce/js/tinymce/skins/content/default/content.min.css') }}">
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            @include('admin.layout.masterLayouts.header_top_menu')
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <!--begin::Sidebar-->
                @include('admin.layout.masterLayouts.sidebar')
                <!--end::Sidebar-->
                <!--begin::Main-->
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ url('/') }}"
                                                class="text-muted text-hover-primary">{{ \App\Helpers\translate('home') }}</a>
                                        </li>
                        ...
                        <!--end::Toolbar-->
                        <!--begin::Content-->
                        @include('admin.layout.masterLayouts.content_wrapper')

                        <!--end::Content-->
                    </div>
                    <!--end::Content wrapper-->

                    @include('admin.layout.masterLayouts.contentFooter')
                </div>
                <!--end:::Main-->
            </div>
            <!--end::Wrapper-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('admin/assets/media/avatars/300-14.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{ asset('admin/assets/media/avatars/300-20.jpg') }}"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('admin/assets/media/avatars/300-1.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('admin/assets/media/avatars/300-23.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset('admin/assets/media/svg/files/doc.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset('admin/assets/media/svg/files/css.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('admin/assets/media/stock/600x400/img-29.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('admin/assets/media/stock/600x400/img-31.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('admin/assets/media/stock/600x400/img-40.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('admin/assets/media/avatars/300-4.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
    ...
    <script src="{{ asset('admin/assets/js/custom/apps/contacts/edit-contact.js') }}"></script>
    ...
    <script>
        ...
        console.log('TinyMCE script loaded:', !!window.tinymce);

        (function() {
            function initEditors() {
                console.log('=== initEditors called ===');
                var textareas = document.querySelectorAll('.tinymce-editor-wrapper textarea');
                var debugComponents = document.querySelectorAll('[data-debug="tinymce-component"]');
                var debugTextareas = document.querySelectorAll('[data-debug="tinymce-textarea"]');

                console.log('Found textareas:', textareas.length);
                console.log('Found debug components:', debugComponents.length);
                console.log('Found debug textareas:', debugTextareas.length);
                console.log('window.tinymce exists:', !!window.tinymce);
                ...
                textareas.forEach(function(textarea, index) {
                    console.log(`Textarea ${index}:`, {
                        ...
                        alreadyInitialized: window.tinymce ? !!tinymce.get(textarea.id) : false
                    });
                    ...
                    if (!window.tinymce) {
                        console.log('Skipping - TinyMCE not available');
                        return;
                    }
                    ...
                    try {
                        tinymce.init({
                            ...
                            menubar: false,
                            height: textarea.dataset.height || 200,
                        ...
                        console.error('Error initializing TinyMCE for', textarea.id, ':', error);
                    }
                });
            }

            function whenTinyMCEReady(callback) {
                if (window.tinymce) { callback(); return; }
                var attempts = 0;
            ...
            // Make initEditors available globally for debugging
            window.debugTinyMCE = initEditors;
            console.log('TinyMCE debug function available as window.debugTinyMCE()');
        })();
        </script>
<script>
    $(function () {
        $('#kt_app_sidebar_toggle').on('click', function () {
            $('#app_sidebar_logo_text').toggle();
        });
    });
</script>
@stack('scripts')
