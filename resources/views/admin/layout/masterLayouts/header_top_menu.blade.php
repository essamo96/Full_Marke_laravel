    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" class="d-lg-none">
                <img alt="Logo" src="{{ asset('yabous_logo.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="background-image:url('admin/assets/media/patterns/menu-header-bg.jpg')">
                            <!--begin::Title-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('admin/assets/default-photo.png') }}" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('admin/assets/default-photo.png') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5 show menu-dropdown"
                            ...
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">{{ \App\Helpers\translate('language') }}
                                    <span
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('app.logout') }}"
                                class="menu-link px-5">{{ \App\Helpers\translate('logOut') }}</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
