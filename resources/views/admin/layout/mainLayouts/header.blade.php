										...
										<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
											...
											<div class="d-flex flex-column px-9">
												...
												<div class="text-center px-4">
													<img class="mw-100 mh-200px" alt="image" src="{{ asset('assets/admin/media/illustrations/sketchy-1/1.png') }}" />
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Wrapper-->
							...
							<div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
									@if(auth('admin')->user() && auth('admin')->user()->photo)
										<img src="{{ asset('storage/' . auth('admin')->user()->photo) }}" alt="user" />
									@else
										<span class="symbol-label fs-2 fw-semibold text-uppercase bg-light-primary text-primary">{{ substr(auth('admin')->user()->name ?? 'A', 0, 1) }}</span>
									@endif
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="z-index: 1050 !important;">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5 symbol-circle">
												@if(auth('admin')->user() && auth('admin')->user()->photo)
													<img alt="Logo" src="{{ asset('storage/' . auth('admin')->user()->photo) }}" />
												@else
													<span class="symbol-label fs-2x fw-semibold text-uppercase bg-light-primary text-primary">{{ substr(auth('admin')->user()->name ?? 'A', 0, 1) }}</span>
												@endif
											</div>
											<!--end::Avatar-->
											<!--begin::Username-->
									...
									<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
										<a href="#" class="menu-link px-5">
											...
											<span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
												...
												<img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('assets/admin/media/flags/' . (app()->getLocale() == 'ar' ? 'palestine.svg' : 'united-states.svg')) }}" alt="" />
											</span></span>
										</a>
										<!--begin::Menu sub-->
										<div class="menu-sub menu-sub-dropdown w-175px py-4">
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="{{ route('admin.lang', 'en') }}" class="menu-link d-flex px-5 {{ app()->getLocale() == 'en' ? 'active' : '' }}">
											...
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="{{ route('admin.lang', 'ar') }}" class="menu-link d-flex px-5 {{ app()->getLocale() == 'ar' ? 'active' : '' }}">
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ asset('assets/admin/media/flags/palestine.svg') }}" alt="" />
												</span>العربية</a>
											</div>
											<!--end::Menu item-->
										</div>
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link px-5">{{ __('app.Sign Out') ?? 'Sign Out' }}</a>
