                                            ...
                                            <div class="tab-pane fade show active" id="basic" role="tabpanel">
                                                <div class="row mb-5">
                                                    <div class="col-md-6 fv-row">
                                                        @include('admin.components.file-picker', ['name' => 'cover_image', 'value' => (isset($info) ? $info->cover_image : null) ?? old('cover_image'), 'label' => \App\Helpers\translate('image'), 'folder' => 'paper_editions/covers'])
                                                    </div>

                                                    <div class="col-md-6 fv-row">
                                                        @include('admin.components.file-picker', ['name' => 'pdf_file', 'value' => (isset($info) ? $info->pdf_file : null) ?? old('pdf_file'), 'label' => 'PDF', 'folder' => 'paper_editions/pdfs'])
                                                    </div>
                                                </div>
