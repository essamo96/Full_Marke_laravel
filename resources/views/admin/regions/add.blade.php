            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body py-4">
                        <form action="{{ isset($info) ? route('regions.edit.submit', ['id' => Crypt::encrypt($info->id)]) : route('regions.add.submit') }}" method="POST">
                            @csrf
                            <div class="row">
                            ...
                            <div class="d-flex justify-content-end mt-5">
                                <a href="{{ route('regions.view') }}" class="btn btn-light me-3">{{ \App\Helpers\translate('cancel') ?? 'إلغاء' }}</a>
